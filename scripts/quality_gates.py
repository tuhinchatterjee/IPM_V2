...
GATES: tuple[Gate, ...] = (
    ...
    Gate("assurance",
         "The six Intelligence Dimensions and the Assurance Record",
         [PYTHON, "-m", "pytest", "-q", "tests/assurance/"]),
    Gate("score-honesty",
         "§212's seven impossibilities, over the payloads the routes return",
         [PYTHON, "-m", "pytest", "-q",
          "tests/assurance/test_reviews_and_honesty.py",
          "tests/assurance/test_assurance_end_to_end.py"]),
