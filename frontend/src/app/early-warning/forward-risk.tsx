...
import { FORWARD_SIGNAL_DESCRIPTION } from "@/lib/ews";
...
/**
 * The CORPORATE Forward Risk Signal screen, kept for the other profile.
 *
 * The Saudi retail installation serves the Early Warning Score workspace at
 * `/early-warning`; this is what that route renders when the product profile
 * is not retail. It is unchanged code, moved out of the retail page so the
 * two are not read as one screen with a branch in it.
 */
...
export function ForwardRiskSignal() {
