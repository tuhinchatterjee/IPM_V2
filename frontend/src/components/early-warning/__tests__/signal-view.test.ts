...
function standing(overrides: Partial<SignalStanding> = {}): SignalStanding {
  ...
  return {
    ...
    priority: "REVIEW",
    priority_label: "Bring forward the review",
    priority_means: "Enough independent evidence to bring the next credit "
      + "review forward rather than wait for it.",
    priority_because: ["At least one condition is severe on its own terms."],
    priority_reasons: [],
    priority_owner: "Credit Risk Analytics",
