...
| PB-042 | Available-module regression and repository lint/type/build checks pass or have exact baseline-supported classifications. | ruff, pytest, tsc, eslint, next build, npm test | full backend suite 9759 passed / 22 skipped / 0 failed; see docs/playbook/UAT_REPORT.md | PASS |
