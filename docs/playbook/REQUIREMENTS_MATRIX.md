...
| PB-040 | Every visible control is exercised; keyboard/focus behavior and laptop layout are verified. | scripts/acceptance/playbook_browser_acceptance.py | 80 checks at 2 viewports; Escape/focus; the change panel and the restore control driven end to end; no console errors | PASS |
