...
> **Stale as of the M6 Playbook merge.** This file is generated by `scripts/feature_matrix.py` against a running build. The rows below are the pre-merge enumeration and do not yet carry the Playbook workspace routes. Regenerate before the final UAT rather than editing by hand.
