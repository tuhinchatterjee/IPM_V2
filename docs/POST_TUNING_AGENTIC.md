# Agentic measurement — after hardening

Generated 2026-08-29T10:09:10+0000 · 3.8s · 15 probes
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| A | What ratings data do you have? | CONVERSATIONAL_NO_ANALYSIS | 1 Credit Analyst | 1 | 0 | 0 | 0 | no | VALIDATED_WITH_LIMITATIONS | 93.8% |
...
| C | Which customers had a rating downgrade and a | MULTI_DOMAIN_ANALYSIS | 3 Portfolio Risk Lead | 2 | 0 | 0 | 3 | yes | VALIDATED_WITH_LIMITATIONS | 92.0% |
| D | Something seems wrong with Contracting. Inve | AGENTIC_COORDINATED_REVIEW | 4 Chief Orchestrator | — | 5 | 5 | 0 | no | VALIDATED_WITH_LIMITATIONS | 94.1% |
| E | Review the latest portfolio and tell me ever | AGENTIC_COORDINATED_REVIEW | 4 Chief Orchestrator | 4 | 5 | 5 | 0 | no | VALIDATED_WITH_LIMITATIONS | 93.8% |
...
| --- | --- | --- | --- |
| L1 A — metadata | L3 C — multi-domain | MATERIAL | tool_call_count, dataset_count |
| L3 C — multi-domain | L4 D — segment investigation | MATERIAL | orchestrated, agent_count, task_count, tool_call_count, dataset_count, coordinated, governed_work |
...
| --- | --- | --- | --- | --- | --- | --- |
| Agentic coordinated review | 2 | 76 | 17 | 93.9% | VALIDATED_WITH_LIMITATIONS | 2 |
| Conversational (no analysis ran) | 10 | 25 | 4 | 92.4% | VALIDATED_WITH_LIMITATIONS | 10 |
