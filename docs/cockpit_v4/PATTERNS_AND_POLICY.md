...
2026-08 it is 9.8% of accounts and **10.4% 30+** against 4.2% for the rest
of the book.
...
Entry into 1-29 goes from 2.3% to 8–12%; Classic and Signature stay near
1.5%, so the product line barely moves. About **seven in ten of the
cohort's 1-29 population sits in 20-29**, reaching 30-59 two months later.
...
Accounts originated **2025-10 … 2025-12** run at **9.85% 30+** at six to
nine months on book, against 3.3–5.4% for the vintages either side.
...
**Auto Finance – Used Vehicle in Qassim**, from 2025-11, at more than twice
the same sub-product elsewhere. Auto Finance is the book's *improving*
product.
...
**Building Contracting**: DSCR falls from **2025Q4** (1.57 → 0.74 by 2026Q2,
against 1.55 → 1.38 for the rest of Construction) and covenant breaches go
from 24% to 69%. The **internal grades lag two quarters** — the cohort is
...
sectors. Aggregate EAD goes 17,557 → 63,029 from 2026Q1; the largest single
name stays at 13,659, comfortably inside CP-1.1's SAR 25,000 million single
obligor limit, while the group crosses CP-1.2's SAR 50,000 million.
...
against a programme rather than an obligor. At 2026Q2 it is 5.0% of
exposure, **11.1% of ECL** and **16.4% stage-3**, the worst product in the
...
| Retail customers / accounts | 12,000 / 16,000 | **26,000 / ~53,000** |
| Corporate rows | 839,960 | **1,260,267** |
| Corporate obligors / facilities | 3,652 / 12,782 | **5,412 / ~19,000** |
