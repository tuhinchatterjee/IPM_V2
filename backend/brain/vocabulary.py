...
_MEASURES: tuple[tuple[str, str, str, str], ...] = (
    ...
    # The same book at facility grain. The measures are the obligor's carried
    # down, so they answer to the same words; what the grain adds is that the
    # answer can be cut by facility rather than only by borrower.
    ("corporate_ifrs9_facility", "ead", "exposure at default", "money"),
    ("corporate_ifrs9_facility", "final_ecl", "expected credit loss", "money"),
    ("corporate_ifrs9_facility", "pd_12m", "twelve-month PD", "rate"),
    ("corporate_ifrs9_facility", "lgd", "loss given default", "rate"),
    ("corporate_ifrs9_facility", "ecl_coverage", "ECL coverage", "rate"),
    ("corporate_ifrs9_facility", "drawn_exposure", "drawn exposure", "money"),
    ("corporate_ifrs9_facility", "utilisation_pct", "utilisation", "rate"),
    ("early_warning_borrower_month", "ews_score", "Early Warning score",
     "score"),
    ("early_warning_borrower_month", "classifier_score", "classifier score",
     "score"),
    ("early_warning_borrower_month", "signal_count_fired", "signals fired",
     "count"),
    ("early_warning_borrower_month", "exposure", "exposure", "money"),
    ("early_warning_borrower_month", "utilisation_pct", "utilisation",
     "rate"),
    ("early_warning_borrower_month", "pd_12m", "twelve-month PD", "rate"),
    ("early_warning_signal_observation", "signal_score", "signal score",
     "score"),
    ("early_warning_signal_observation", "trigger_severity_score",
     "trigger severity", "score"),
    ("early_warning_signal_observation", "occurrences", "occurrences",
     "count"),
...
_DIMENSIONS: tuple[tuple[str, str, str], ...] = (
    ...
    ("corporate_ifrs9_facility", "stage", "IFRS 9 stage"),
    ("corporate_ifrs9_facility", "product_type", "product type"),
    ("early_warning_borrower_month", "ews_band", "Early Warning band"),
    ("early_warning_borrower_month", "dominant_driver", "dominant driver"),
    ("early_warning_borrower_month", "sector", "sector"),
    ("early_warning_borrower_month", "segment", "segment"),
    ("early_warning_borrower_month", "ifrs9_stage", "IFRS 9 stage"),
    ("early_warning_signal_observation", "signal_key", "signal"),
    ("early_warning_signal_observation", "layer", "intelligence layer"),
    ("early_warning_signal_observation", "sub_category", "signal category"),
    ("early_warning_signal_observation", "trigger_severity_band",
     "severity band"),
    ("early_warning_external_event_synthetic", "trigger_key",
     "external trigger"),
    ("early_warning_external_event_synthetic", "severity_band",
     "severity band"),
    ("early_warning_external_event_synthetic", "evidence_type",
     "evidence type"),
    ("early_warning_external_event_synthetic", "source_tier", "source tier"),
...
EVENT_DATASETS: frozenset[str] = frozenset({
    ...
    # External intelligence attached to a borrower: a trigger, a severity band
    # and where it came from. Nothing on the row is a quantity, so a question
    # over it counts rows or filters them, which is exactly the exemption.
