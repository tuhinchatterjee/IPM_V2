...
STORIES: tuple[Story, ...] = (
    Story("STORY_GROWTH_STABLE_QUALITY", "Growth with stable quality",
          ...
          {"exposure_growth": 0.11, "ebitda_growth": 0.10, "rating_drift": 0.0,
           ...
           "hold_macro": True}),
    Story("STORY_CASH_DETERIORATION", "Deteriorating cash generation and rating",
          ...
          {"exposure_growth": 0.01, "ebitda_growth": -0.085,
           "rating_drift": 0.55}),
    Story("STORY_COLLATERAL_WEAKENING", "Collateral weakening with stable PD",
    ...
    Story("STORY_IMPROVING_CREDIT", "Improving credit",
          ...
          {"exposure_growth": 0.02, "ebitda_growth": 0.075,
           "rating_drift": -0.5}),
    Story("STORY_WEIGHTS_ONLY", "Scenario-weight-only ECL movement",
    ...
    Story("STORY_OVERLAY_CHANGE", "An overlay change",
          ...
          {"exposure_growth": 0.0, "ebitda_growth": 0.0, "rating_drift": 0.0,
           ...
           "hold_utilisation": True}),
    Story("STORY_BREACH_WITH_WAIVER", "Covenant breach with a valid waiver",
    ...
    Story("STORY_EXPIRING_WAIVER", "An expiring waiver",
    ...
    Story("STORY_STAGE_1_TO_2", "Stage 1 to Stage 2 migration",
    ...
    Story("STORY_STAGE_3_RECOVERY", "Stage 3 with changing expected recoveries",
    ...
    Story("STORY_NEW_LENDING", "New lending",
    ...
    Story("STORY_REPAYMENT", "Repayment",
    ...
    Story("STORY_WRITE_OFF", "Write-off reducing reported exposure",
    ...
    Story("STORY_OFFSETTING_SEGMENTS", "Offsetting segment movements",
          ...
          {"exposure_growth": 0.0, "ebitda_growth": -0.07,
           "rating_drift": 0.8}),
    Story("STORY_OFFSETTING_SEGMENTS_MIRROR", "The other side of the offset",
          "The mirror of OFFSETTING_SEGMENTS, improving by a similar amount.",
          {"exposure_growth": 0.0, "ebitda_growth": 0.07,
           "rating_drift": -0.8}),
    Story("STORY_STALE_STATEMENTS", "Stale or missing statements",
    ...
    Story("STORY_SHARED_COLLATERAL", "Shared collateral across facilities",
          ...
          {"exposure_growth": 0.01, "ebitda_growth": 0.01,
           "shared_collateral": 3}),
    Story("STORY_GROUP_CONCENTRATION", "Concentration in a small connected group",
