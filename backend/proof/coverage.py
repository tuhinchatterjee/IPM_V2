...
_ENTRIES: tuple[Entry, ...] = (
    ...
    _e("cohort_construction", state=PLANNED,
       ...
       owner="runtime"),
    _e("expected_output_visual_intent", state=PLANNED,
    ...
    _e("actionability", state=PLANNED, source_system="judgment rubric",
    ...
    _e("table_column_ordering", state=PLANNED,
    ...
    _e("follow_up_quality", state=PLANNED,
