...
@register(AnalysisContract(
    ...
    outputs=[
        OutputField("total_ead", "Total exposure at default.", "number", unit="SAR mn", precision=1),
...
def portfolio_summary(ctx: ExecutionContext) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        units={"total_ead": "SAR mn", "total_ecl": "SAR mn", "ecl_coverage_pct": "%",
...
@register(AnalysisContract(
    ...
    outputs=[
        ...
        OutputField("ead", "Exposure at default in the stage.", "number", unit="SAR mn", precision=1),
        OutputField("ead_pct", "Share of total exposure.", "number", unit="%", precision=2),
        OutputField("total_ecl", "ECL held against the stage.", "number", unit="SAR mn", precision=2),
...
def stage_distribution(ctx: ExecutionContext) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        units={"ead": "SAR mn", "total_ecl": "SAR mn", "ead_pct": "%", "coverage_pct": "%"},
...
def sector_concentration(ctx: ExecutionContext) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        units={"ead": "SAR mn", "ead_pct": "%", "coverage_pct": "%", "npl_pct": "%"},
        input_row_count=int(len(df)),
        warnings=ctx.warnings,
