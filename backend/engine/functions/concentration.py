...
@register(AnalysisContract(
    ...
    outputs=[
        OutputField("total_ead", "Total exposure at default.", "number", unit="SAR mn", precision=2),
...
def obligor_concentration(ctx: ExecutionContext) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        units={"ead": "SAR mn", "total_ecl": "SAR mn", "share_pct": "%",
...
@register(AnalysisContract(
    ...
    outputs=[
        ...
        OutputField("unsecured_ead", "Exposure with no collateral against it.", "number", unit="SAR mn", precision=2),
        OutputField("shortfall_ead", "Exposure in excess of collateral value.", "number", unit="SAR mn", precision=2),
...
def collateral_coverage(ctx: ExecutionContext) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        units={"ead": "SAR mn", "collateral": "SAR mn", "shortfall": "SAR mn",
               "total_ecl": "SAR mn", "coverage_pct": "%"},
        input_row_count=int(len(df)),
        warnings=ctx.warnings,
...
@register(AnalysisContract(
    ...
    outputs=[
        ...
        OutputField("additions_ead", "Exposure that joined.", "number", unit="SAR mn", precision=2),
        OutputField("net_ead", "Exposure joining less exposure leaving.", "number", unit="SAR mn", precision=2),
    ],
    validation_rules=[
...
@register(AnalysisContract(
    ...
    outputs=[
        ...
        OutputField("drawing_ead", "Exposure of those facilities.", "number", unit="SAR mn", precision=2),
        OutputField("largest_move_pp", "The largest single increase.", "number", unit="pp", precision=2),
        OutputField("remaining_headroom", "Undrawn limit still available to them.", "number", unit="SAR mn", precision=2),
    ],
    validation_rules=[
...
def utilisation_drift(ctx: ExecutionContext) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        units={"ead": "SAR mn", "utilisation_pct": "%", "prev_utilisation_pct": "%",
               "utilisation_move_pp": "pp", "headroom": "SAR mn", "dscr": "x"},
        input_row_count=int(len(df)),
        warnings=ctx.warnings,
