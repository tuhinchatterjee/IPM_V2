#!/usr/bin/env bash
#
# Stop the ten-journeys retail build (CP-RA-V2) — and nothing else.
#
# Every process this stops was started by start-anb2.command and recorded its
# own pid in var/anb2. There is no kill-by-name and no kill-by-port here: a
# broad process-name kill would take the frozen 5328/8328 presentation, the accepted
# 5330/8330 ANB demonstration or the 5332/8332 Planner UAT down
...
ours() {
  case "$1" in
    *8334*|*5334*|*uvicorn*|*"npm run dev"*|*"next dev"*|*next-server*|*node*)
      return 0 ;;
    *) return 1 ;;
  esac
}
...
printf 'Stopping the ten-journeys retail build (5334/8334)\n'
...
if [ "$still_held" -eq 0 ]; then
  printf 'Done. Both ports are free, and nothing on 5328/8328, 5330/8330 or 5332/8332 was touched.\n'
else
